...
expName = 'cong_test'  # from the Builder filename that created this script
...
win = visual.Window(size=(1280, 800), fullscr=True, screen=0, allowGUI=False, allowStencil=False,
    monitor='testMonitor', color=[0,0,0], rgb=[0.2,0.2,0.2], colorSpace='rgb',
...
import random
temp=random.sample(range(0,132),36)
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    elif hexa.status == STARTED and t >= (0.0 + (120-win.monitorFramePeriod*0.75)): #most of one frame period left
   ...
   # *cross* updates
    ...
    elif cross.status == STARTED and t >= (0.0 + (120-win.monitorFramePeriod*0.75)): #most of one frame period left
...
#    elif downy1.status == STARTED and t >= (0.0 + (120-win.monitorFramePeriod*0.75)): #most of one frame period left
...
#    elif upy.status == STARTED and t >= (0.0 + (120-win.monitorFramePeriod*0.75)): #most of one frame period left
...
# *mouse* updates
    ...
    elif mouse.status == STARTED and t >= (0.0 + (120.0-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    elif downy2.status == STARTED and t >= (0.0 + (120-win.monitorFramePeriod*0.75)): #most of one frame period left
        downy2.setAutoDraw(False)
    if downy2.status == STARTED and mouse.leftButton[-1] == 0:  # only update if being drawn
        downy2.setOpacity(0.0)
    if downy2.status == STARTED and mouse.leftButton[-1] != 0:  # only update if being drawn
...
thisExp.addData('iscong', 1)
thisExp.addData('istest', 1)
thisExp.nextEntry()
win.close()
core.quit()
