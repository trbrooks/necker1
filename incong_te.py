...
expName = 'incong_test'  # from the Builder filename that created this script
...
hexa = visual.ImageStim(win=win, name='hexa',units='pix', 
    image='/Users/trbrooks/Desktop/Spring 2016/necker/images/necker_cube.png', mask=None,
    ori=0, pos=[0, 0], size=[120,108],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
cross = visual.ImageStim(win=win, name='cross',units='pix', 
    image='/Users/trbrooks/Documents/images/cross.png', mask=None,
...
upy = visual.ImageStim(win=win, name='upy',units=u'pix', 
    image=u'/Users/trbrooks/Documents/necker/images/downy1.png', mask=None,
    ori=0, pos=[0,0], size=[120,108],
    color=[1,1,1], colorSpace=u'rgb', opacity=1.0,
