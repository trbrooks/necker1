...
hexa = visual.ImageStim(win=win, name='hexa',units='pix', 
    image='/Users/trbrooks/Documents/Past Semesters/Spring 2016/necker/images/necker_cube.png', mask=None,
    ori=0, pos=[0, 0], size=[120,108],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
cross = visual.ImageStim(win=win, name='cross',units='pix', 
    image='/Users/trbrooks/Documents/Past Semesters/Spring 2016/necker/images/cross.png', mask=None,
    ori=0, pos=[0, 0], size=[30,30],
    color=[1,1,1], colorSpace='rgb', opacity=0.9,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
downy1 = visual.ImageStim(win=win, name='downy1',units=u'pix', 
    image=u'/Users/trbrooks/Documents/Past Semesters/Spring 2016/necker/images/downcube.png', mask=None,
    ori=0, pos=[0, 0], size=[120,108],
...
#-------Start Routine "trial"-------
#create a random string of numbers from 0 to 150.
import random
